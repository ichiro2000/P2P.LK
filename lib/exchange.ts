 ...
 * tree gets used as the basis for both deployments — this `main` branch
 * is the Binance build; the `bybit` branch flips ACTIVE_EXCHANGE to
 * `"bybit"` and swaps the data layer.
 *
